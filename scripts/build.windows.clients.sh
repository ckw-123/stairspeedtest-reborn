...
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-O2 -ffunction-sections -fdata-sections -fno-rtti -Wl,--disable-reloc-section,--gc-sections,-static,--strip-all" -DENABLE_MYSQL=OFF -G "Unix Makefiles" .
make clean
make VERBOSE=1 -j4
