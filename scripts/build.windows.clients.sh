...
cmake -DCMAKE_CXX_FLAGS_RELEASE="-O2 -DNDEBUG -ffunction-sections -fdata-sections -fno-rtti -Wl,--disable-reloc-section,--gc-sections,-static,--strip-all" -DENABLE_MYSQL=OFF -G "Unix Makefiles" .
make clean
make VERBOSE=1 -j4
